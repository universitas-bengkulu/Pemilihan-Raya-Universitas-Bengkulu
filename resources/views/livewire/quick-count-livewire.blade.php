<div>
    ...
    <div class="        overflow-hidden         h-screen   grid grid-cols-5 ">
        <div class="col-span-1 grid relative">
            ...
            <div class=" mx-auto text-center items-center  place-self-center">
                <a href="{{ route('dashboard') }}" class="py-2 mb-3 absolute w-56 inline-flex top-5 left-4 duration-300 transform hover:scale-[99%] bg-white shadow-inner shadow-gray-700 focus:scale-95   rounded-md mx-auto   px-3  text-center  text-black text-sm     "><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 mt-1" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
    ...
    @push('js')
    <script>
        //refresh setiap 3 menit = 180000ms
        setInterval(() => Livewire.dispatch('updateData'), 180000);
