<div>
            ...
            <div class="col-span-1 grid relative">
                ...
                <div class=" mx-auto text-center items-center  place-self-center">
                    <a href="{{ route('dashboard') }}"
                        class="py-2 mb-3 absolute w-56 inline-flex top-5 left-4 duration-300 transform hover:scale-[99%] bg-white shadow-inner shadow-gray-700 focus:scale-95   rounded-md mx-auto   px-3  text-center  text-black text-sm     "><svg
                            xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 mt-1" width="16" height="16"
                    ...
                    <div>
                        <img src="{{ asset('assets/frontend/logo.webp') }}" alt="kotak-suara"
                            ...
                            class="h-36 rounded-full  md:mt-10 mx-auto animate-[bounce_3s_infinite]   ">
    ...
    @else
        <div class="h-screen grid">
            <div
                class="place-self-center container md:mx-auto mx-4 bg-red-100 bg-opacity-50 shadow-md rounded-md shadow-gray-300 py-20 ">
                <div class="px-10 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-44 w-44 mx-auto text-red-800" fill="currentColor"
            ...
            <footer class="absolute bottom-0      z-50 bg-[#E73530]   w-full   ">
                <div class="px-12 mx-auto py-3   flex flex-wrap flex-col sm:flex-row    ">
                    <p class="text-white mx-auto  text-xs md:text-sm text-center sm:text-left">Copyright&copy; 2023 |
                        <a href="#" class="text-yellow-500 font-bold">KPU UNIVERSITAS BENGKULU</a>. All rights
                        reserved.
                    </p>
                </div>
            </footer>
